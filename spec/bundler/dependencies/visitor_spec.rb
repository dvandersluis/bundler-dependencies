  ...
  describe '#walk' do
    it 'traverses the tree' do
      ...
      expect(arr).to eq([
        ...
        [:"ruby-progressbar", 1], [:"unicode-display_width", 1], [:"rubocop-rspec", 0], [:rubocop, 1], [:jaro_winkler, 2],
        [:parallel, 2], [:parser, 2], [:ast, 3], [:rainbow, 2], [:"ruby-progressbar", 2], [:"unicode-display_width", 2]
      ])
    end
  end
end
